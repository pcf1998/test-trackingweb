...
describe("Team", () => {
    ...
    describe("POST /tracings/:projectID/teams/:teamID/teamMembersID", () => {
        ...
        describe("when the project id and team id are valid", () => {
            it("should return confirmation message and add team member id", () => {
                request(server)
                    .post("/tracings/5db57b283e7f3c0666c9c0b8/teams/5db5d622aa962a17eaf9ccb1/teamMembersID")
                    .set("Accept", "application/json")
                    .expect("Content-Type", /json/)
                    .send({teamMembersID: ["5db579283e7f3c0666c9c0b4"]})
                    .expect(200)
                    .end((err, res) => {
                        expect({message: "team Members ID Successfully Added!"})
                        done(err)
                    })
            })
        })
        ...
        describe("when the team id is invalid", () => {
            it("should return the NOT found message", done => {
                request(server)
                    .post("/tracings/5db57b283e7f3c0666c9c0b8/teams/9999/teamMembers")
                    .set("Accept", "application/json")
                    .expect("Content-Type", "text/html; charset=utf-8")
                    .expect(404)
                    .expect({}, (err, res) => {
    ...
    describe("DELETE /tracings/:projectID/teams/:teamID", () => {
        ...
        describe("when the project id and team id are valid", () => {
            it("should return confirmation message and delete the team", done => {
                request(server)
                    .delete("/tracings/5db57b283e7f3c0666c9c0b8/teams/5dc1b2a854f0d12960f7c332")
                    .set("Accept", "application/json")
                    .expect("Content-Type", /json/)
                    .expect(200)
                    .end((err, res) => {
        ...
        describe("when the project id is invalid", () => {
            it("should return the NOT found message", done => {
                request(server)
                    .delete("/tracings/9999/teams/5dc1b2a854f0d12960f7c332")
                    .set("Accept", "application/json")
                    .expect("Content-Type", /json/)
                    .expect(200)
                    .expect({
        ...
        describe("when the project id, team id and team member id are valid", () => {
            it("should return confirmation message and delete the team member id", done => {
                request(server)
                    ...
                    .expect(200)
                    .end((err, res) => {
                        expect({message: "team member ID Successfully Deleted!"})
                        done(err)
                    })
            })
        })
