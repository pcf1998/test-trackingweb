...
describe("User", () => {
  ...
  describe("PUT /users/:userID/leave", () => {
    it("should return confirmation message and update user profile", () => {
      request(server)
        .put("/users/5db5789c3e7f3c0666c9c0b0/leave")
        .set("Accept", "application/json")
        .expect("Content-Type", /json/)
        .expect(200)
        .end((err, res) => {
          expect({message: "user leave Successfully!"})
          done(err)
        })
    })
  })
  ...
  describe("DELETE /users/:userID", () => {
    ...
    describe("when the user id is valid", () => {
      it("should return confirmation message and delete the user", done => {
        request(server)
          .delete("/users/5dc1892b191d551afbf5dd1a")
          .set("Accept", "application/json")
          .expect("Content-Type", /json/)
          .expect(200)
          .end((err, res) => {
